#!/usr/bin/env python3
"""
Simple test script for GM12U320 projector
Generates a basic test pattern to verify data format
"""
...
def create_basic_test_pattern():
    """Create a very basic test pattern"""
...
def main():
    print("🧪 Simple Test Pattern Generator")
    print("================================")
    
    # Create test pattern
    print("Creating basic test pattern...")
    data = create_basic_test_pattern()
