#!/usr/bin/env python3
"""
GM12U320 Live Screen Mirror
Captures screen every 100ms and updates projector in real-time
"""
...
# Capture settings
CAPTURE_INTERVAL = 0.1  # 100ms
CAPTURE_MONITOR = 0  # Primary monitor
...
class LiveMirror:
    ...
    def start(self):
        ...
        print("GM12U320 Live Screen Mirror")
        print("============================")
        print("This will mirror your screen to the projector in real-time")
